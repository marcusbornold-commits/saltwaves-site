...
It also doesn't stop at de-reverb. Echo is rarely the only problem in a real recording — there's usually some boxiness, some harshness, [inconsistent levels and loudness](/blog/how-loud-should-a-podcast-be-lufs-guide) to deal with too. PodMaster runs the de-reverbed voice through a full mastering chain (EQ, gating, compression, de-essing, loudness normalisation) so the output is a finished, broadcast-ready episode rather than just a de-echoed file you still have to mix.
