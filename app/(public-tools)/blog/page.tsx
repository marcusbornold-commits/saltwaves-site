export const metadata = { title: "Podcast Audio Guides | Saltwaves Studio", description: "Practical guides to podcast mastering, loudness and clearer recordings.", alternates: { canonical: "/blog" } };
